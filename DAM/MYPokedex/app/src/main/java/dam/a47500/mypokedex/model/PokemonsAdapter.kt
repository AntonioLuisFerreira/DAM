...
import dam.a47500.mypokedex.databinding.ItemPokemonBinding
import dam.a47500.mypokedex.domain.entities.Pokemon

class PokemonsAdapter(
    private val pokemonList: List<dam.a47500.mypokedex.domain.entities.Pokemon>,
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindView(pokemon: dam.a47500.mypokedex.domain.entities.Pokemon, itemClickListener: (Pokemon) -> Unit) {
