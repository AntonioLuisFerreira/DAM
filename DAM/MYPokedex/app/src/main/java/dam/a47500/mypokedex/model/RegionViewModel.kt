...
import dam.a47500.mypokedex.domain.database.FirebaseRegionRepository
...
class RegionsViewModel : ViewModel() {
    ...
    private lateinit var _repository: FirebaseRegionRepository
    fun initViewMode(repository: FirebaseRegionRepository) {
